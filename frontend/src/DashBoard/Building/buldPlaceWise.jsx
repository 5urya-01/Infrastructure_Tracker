...
const BuildPlaceWise = () => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_BACKEND_URL + "/building/getCountByCompany/" + buildingId)
    .then((res) => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_BACKEND_URL + "/building/getCountByCompanyAndItemName/" + buildingId)
    .then((res) => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_BACKEND_URL + "/building/getTotalTypesOfConsumptionGroupedByItemName/" + buildingId)
    .then((res) => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_BACKEND_URL + "/building/getCountByCondition/" + buildingId)
    .then((res) => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_BACKEND_URL + "/building/getCountByCategory/" + buildingId)
    .then((res) => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_BACKEND_URL + "/building/getAllItemCount/" + buildingId)
    .then((res) => {
