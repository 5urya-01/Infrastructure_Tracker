...
const BuildPlaceWise = () => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_BACKEND_URL + "/room/getCountByCompany/" + roomId)
    .then((res) => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_BACKEND_URL + "/room/getCountByCompanyAndItemName/" + roomId)
    .then((res) => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_BACKEND_URL + "/room/getTotalTypesOfConsumptionGroupedByItemName/" + roomId)
    .then((res) => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_BACKEND_URL + "/room/getCountByCondition/" + roomId)
    .then((res) => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_BACKEND_URL + "/room/getCountByCategory/" + roomId)
    .then((res) => {
  ...
  useEffect(() => {
    axios.get(process.env.REACT_APP_BACKEND_URL + "/room/getAllItemCount/" + roomId)
    .then((res) => {
