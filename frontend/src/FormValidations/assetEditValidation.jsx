...
const AssetEditForm = ({ asset = null, onSubmit, isEditMode }) => {
  const defaultValues = {
    assetType: "",
    buildingId: "",
    floorId: "",
  ...
  const [form, setForm] = useState(asset || defaultValues);
  ...
  const defaultProperties = {
    ...
    cctvCamera: { Brand: "", Resolution: "", Storage: "", Framerate: "" },
    tv: { Brand: "", Color: "" },
  ...
  useEffect(() => {
    if (asset) {
      ...
      setCustomProperties(asset.customProperties || []);
    }
  }, [asset]);
  ...
  useEffect(() => {
    updateItemId();
  }, [form.buildingId, form.floorId, form.roomId, form.hallId, form.assetType]);
  ...
  const updateItemId = () => {
    const { buildingId, floorId, roomId, hallId, assetType } = form;
    let idComponents = [];
  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit}>
          ...
          <Col md="6">
            <FormGroup>
              ...
              <Input
                ...
                readOnly={isEditMode} // Make it read-only in edit mode
              />
            </FormGroup>
          </Col>
          <Col md="6">
        ...
        <Row>
          <Col md="6">
            <FormGroup>
              ...
              <Input
                type="select" // Changed back to dropdown
                name="status"
                id="status"
                value={form.status}
                onChange={handleChange}
        ...
        {/* Show Consumption field only if the category is Electrical */}
